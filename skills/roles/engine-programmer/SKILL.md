...
description: "引擎程序：渲染/物理/工具链/内存：引擎核心、物理系统、编辑器工具、内存优化"
runAs: inline
profiles: balanced
cost: medium
---
...
引擎程序：渲染/物理/工具链/内存：引擎核心、物理系统、编辑器工具、内存优化
...
```
════════════════════════════════════
💻 engine-programmer完成 · dev-done_task-done
产出来 skills/roles/engine-programmer/

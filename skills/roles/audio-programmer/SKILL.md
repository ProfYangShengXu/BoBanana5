...
description: "音频程序：Wwise/FMOD集成/音频引擎/空间音频：音频中间件、引擎集成、3D音频"
runAs: inline
profiles: balanced
cost: medium
---
...
音频程序：Wwise/FMOD集成/音频引擎/空间音频：音频中间件、引擎集成、3D音频
...
```
════════════════════════════════════
💻 audio-programmer完成 · dev-done_task-done
产出来 skills/roles/audio-programmer/

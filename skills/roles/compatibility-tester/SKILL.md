...
description: "兼容性测试：多设备/多系统/硬件配置：设备兼容性、系统兼容性、硬件配置测试"
runAs: inline
profiles: balanced
cost: medium
---
...
兼容性测试：多设备/多系统/硬件配置：设备兼容性、系统兼容性、硬件配置测试
...
```
════════════════════════════════════
🧪 compatibility-tester完成 · test-done_layer-all-done
产出来 skills/roles/compatibility-tester/

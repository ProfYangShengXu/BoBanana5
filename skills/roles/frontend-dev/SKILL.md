---
name: frontend-dev
description: "前端开发：Web/移动端 UI、组件库、交互优化。React/Vue/TS"
runAs: inline
profiles: balanced
cost: medium
---
...
按 PRD 接口签名实现功能代码。前端开发：Web/移动端 UI、组件库、交互优化。React/Vue/TS
...
```
════════════════════════════════════
🔧 frontend-dev完成 · task-done
产出来 skills/roles/frontend-dev/

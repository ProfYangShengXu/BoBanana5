---
name: ai-programmer
description: "AI程序：行为树/寻路/机器学习：角色AI、寻路系统、数据驱动行为、ML集成"
runAs: inline
profiles: balanced
cost: medium
---
...
AI程序：行为树/寻路/机器学习：角色AI、寻路系统、数据驱动行为、ML集成
...
```
════════════════════════════════════
💻 ai-programmer完成 · dev-done_task-done
产出来 skills/roles/ai-programmer/

...
description: "客户端程序：Gameplay/UI/网络/渲染：游戏逻辑、界面开发、客户端网络、渲染管线"
runAs: inline
profiles: balanced
cost: medium
---
...
客户端程序：Gameplay/UI/网络/渲染：游戏逻辑、界面开发、客户端网络、渲染管线
...
```
════════════════════════════════════
💻 client-programmer完成 · dev-done_task-done
产出来 skills/roles/client-programmer/

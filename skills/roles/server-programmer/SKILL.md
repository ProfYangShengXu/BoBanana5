...
description: "服务端程序：后端/数据库/网关/防外挂：游戏服务器、数据持久化、安全策略"
runAs: inline
profiles: balanced
cost: medium
---
...
服务端程序：后端/数据库/网关/防外挂：游戏服务器、数据持久化、安全策略
...
```
════════════════════════════════════
💻 server-programmer完成 · dev-done_task-done
产出来 skills/roles/server-programmer/

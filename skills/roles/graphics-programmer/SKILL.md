...
description: "图形程序：Shader/光照/后处理/GPU：渲染特效、光照系统、后期管线、GPU优化"
runAs: inline
profiles: balanced
cost: medium
---
...
图形程序：Shader/光照/后处理/GPU：渲染特效、光照系统、后期管线、GPU优化
...
```
════════════════════════════════════
💻 graphics-programmer完成 · dev-done_task-done
产出来 skills/roles/graphics-programmer/

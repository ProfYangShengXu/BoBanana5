...
for %%s in (pipeline docs cycle loop install bobanana hr) do (
...
if exist "%SOURCE_DIR%commands\bobanana.md" copy /Y "%SOURCE_DIR%commands\bobanana.md" ".reasonix\commands\bobanana.md" >nul
...
if not exist reasonix.toml (
  ...
  echo # Reasonix config - auto-generated by Bobanana 5.0 > reasonix.toml
  echo. >> reasonix.toml

---
name: vfx-artist
description: "特效师(VFX)：技能/环境/后期/粒子特效：粒子系统、Shader特效、时序动画、性能预算"
runAs: inline
profiles: balanced
cost: medium
---
...
特效师(VFX)：技能/环境/后期/粒子特效：粒子系统、Shader特效、时序动画、性能预算
...
```
════════════════════════════════════
🎨 vfx-artist完成 · design-done
产出来 skills/roles/vfx-artist/

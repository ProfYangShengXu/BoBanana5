...
description: "功能测试：用例设计/回归测试/缺陷跟踪/探索性测试：测试用例、Bug验证、质量报告"
runAs: inline
profiles: balanced
cost: medium
---
...
功能测试：用例设计/回归测试/缺陷跟踪/探索性测试：测试用例、Bug验证、质量报告
...
```
════════════════════════════════════
🧪 functional-tester完成 · test-done_layer-all-done
产出来 skills/roles/functional-tester/

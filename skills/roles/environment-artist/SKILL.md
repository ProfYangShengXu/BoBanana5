...
description: "场景美术：地表/植被/灯光/氛围：场景搭建、光照烘焙、氛围营造、性能优化"
runAs: inline
profiles: balanced
cost: medium
---
...
场景美术：地表/植被/灯光/氛围：场景搭建、光照烘焙、氛围营造、性能优化
...
```
════════════════════════════════════
🎨 environment-artist完成 · design-done
产出来 skills/roles/environment-artist/

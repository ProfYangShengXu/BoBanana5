...
description: "自动化测试：脚本开发/CI集成/性能基准：自动化框架、持续集成、性能基准测试"
runAs: inline
profiles: balanced
cost: medium
---
...
自动化测试：脚本开发/CI集成/性能基准：自动化框架、持续集成、性能基准测试
...
```
════════════════════════════════════
🧪 automation-tester完成 · test-done_layer-all-done
产出来 skills/roles/automation-tester/
